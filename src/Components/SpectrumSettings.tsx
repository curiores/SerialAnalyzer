...
/* The spectrum settings pane.
   Uses references to reset the children's state values
   when the auto button is deselected.

   TODO: Could refector the checkboxes inside the children so that 
   they interact more directly with the states.
*/
